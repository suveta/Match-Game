...
def game2player() -> None :
    ...
    try:
        ...
        print("\n Niveau facile : F\n Niveau intermédiaire :I allumettes\n Niveau Difficile :D")
            ...
            for  player in players :
                ...
                if (player == "player1"):
                    ...
                    if (liste2[0] == 'paire'):
                       ...
                       playerChoice = minmax(situation_paire, True, dept, oddList,evenList)
                       ...
                       print(f"\n le nombre d'allumettes en jeu : {len(grid)}")
                        ...
                        playerChoice = minmax(situation_impaire, True, dept,oddList, evenList)
                        print(f"joueur 2 a choisi :{playerChoice}")
                        if not(playerChoice in oddList) :
                            raise GameException("Vous avez choisi qui n'existe pas dans la liste") 
